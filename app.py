...
optinons = Options()
optinons.add_experimental_option("detach", True)

driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=optinons)
...
with open("result.txt", "w") as file:
    for button in buttons:
        text = button.get_attribute("innerHTML").replace("&nbsp;", " ")
        file.write(text + "\n")